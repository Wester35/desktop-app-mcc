...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.interval_window.setGeometry(QRect(280, 170, 211, 41))
        self.integral_window = QPushButton(MainWindow)
        self.integral_window.setObjectName(u"integral_window")
        self.integral_window.setGeometry(QRect(20, 170, 211, 41))
