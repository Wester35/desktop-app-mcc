...
"")
        ...
        self.usernameEdit.setGeometry(QRect(20, 150, 321, 30))
        self.passwordEdit = QLineEdit(self.frame)
        self.passwordEdit.setObjectName(u"passwordEdit")
        self.passwordEdit.setGeometry(QRect(20, 230, 321, 30))
...
"}")
        ...
        QWidget.setTabOrder(self.passwordEdit, self.checkBox)
        QWidget.setTabOrder(self.checkBox, self.checkPassword)
        QWidget.setTabOrder(self.checkPassword, self.pushButton)
        QWidget.setTabOrder(self.pushButton, self.to_register)
