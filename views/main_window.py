...
class MainWindow(QMainWindow):
    ...
    def show_user_guide(self):
        ...
        help_text = (
            ...
            "⚠️ВАЖНО: Если в модели присутствуют факторы, имеющие важное смысловое значение,\n"
            "но они оказались статистически незначимыми (|tфакт| < tкр),\n"
            "рекомендуется отключить автоматическое пошаговое исключение факторов.\n\n"
            "📈 Просмотр графиков\n"
            "--------------------\n"
