...
def get_integral_indicators(correl_matrix: pd.DataFrame):
    integral_correl = correl_matrix['integrated_index'].round(15)
    filtered = integral_correl[(abs(integral_correl) > 0.19) & (integral_correl.index != 'integrated_index')]
    return filtered
...
if __name__ == "__main__":
    ...
    print(get_integral_indicators(get_correl_matrix(db, years)))